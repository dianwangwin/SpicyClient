...
public class LayerCape implements LayerRenderer
{
    ...
    {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn.getLocationCape() != null && RandomUtils.shouldRenderCapeOnPlayer(entitylivingbaseIn))
        {
