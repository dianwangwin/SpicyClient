...
import info.spicyclient.spicyMessageClient.networking.packets.BasicPacket;
import info.spicyclient.spicyMessageClient.networking.packets.HandshakePacket;
					...
					while (socketClientBound.hasNext()) {
						...
						if (message.equalsIgnoreCase("ping!")) {
							...
							if (handshakeCompleted) {
								...
								System.out.println(handshakePacket.stage);
