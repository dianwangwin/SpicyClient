...
public class Scaffold extends Module {
	...
	public Scaffold() {
		super("Scaffold", Keyboard.KEY_NONE, Category.COMMUNITY);
		resetSettings();
	}
	
	public ModeSetting watermark = new ModeSetting("Created by", "Thomaz#3000", "Thomaz#3000");
	...
	public void resetSettings() {
		this.settings.clear();
		this.addSettings(watermark, timerBoost, tower, swing);
	}
	...
	public void onEvent(Event e) {
		...
		if (e instanceof EventUpdate) {
			...
			this.additionalInformation = "Thomaz#3000";
            ...
            //Tower
            if (e.isPre() && getBlockSlot() != -1 && mc.gameSettings.keyBindJump.isKeyDown() && !MovementUtils.isMoving() && tower.isEnabled()) {
